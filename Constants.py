...
from Exceptions.ValidateExceptions import InvalidBirthDate, InvalidParticipantAge, InvalidValueLength, \
    InputFileDoesNotExist, InvalidInputKeys, InvalidUUID, ContextPathDoesNotExist, DataFileDoesNotExist, DateOutOfRange, \
...
valid_exceptions = [InputFileDoesNotExist, InvalidInputKeys, InvalidUUID, ContextPathDoesNotExist,
                            ...
                            InvalidBirthDate, InvalidParticipantAge, InvalidValueLength, LoaderException]